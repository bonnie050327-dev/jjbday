...
function Button() {
  ...
  return (
    <button 
      ...
      className="absolute bg-[#335a99] content-stretch flex gap-[8px] h-[52px] items-center justify-center left-[145px] overflow-clip p-[12px] rounded-[50px] top-[596px] w-[103px] cursor-pointer hover:bg-[#2a4a7f] transition-colors" 
      data-name="Button"
    >
...
export function StartScreen() {
  return (
    <div className="bg-[#eef6ff] relative size-full min-h-screen" data-name="iPhone 16 & 17 Pro - 3">
